...
for file_comb, file_surf in lowAmp_dirc_zipped:
	...
	# Creating a limited x range for tangent and perpendicular lines # 
	...
	# Computing delta_x for perpendicular line (it should be the same length) 
